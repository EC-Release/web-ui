...
export default class Maintainagentcreate extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            gatewayForm: {
                ...
                host: { value: 'ws://asda/agent', dirtyState: false },
            ...
            serverForm: {
                ...
                OAuth2: { value: 'abc', dirtyState: false },
            ...
            subscriptions: [{subscriptionId:'1',subscriptionName:'test'},
            {subscriptionId:'2',subscriptionName:'test2'},
            {subscriptionId:'3',subscriptionName:'test3'}],
            ...
            gateways: [
            {name:'ws://a/agent',id:'1'},
            {name:'ws://b/agent',id:'2'},
            {name:'ws://c/agent',id:'3'}
        ],
            ...
            groups: [{groupId:'aad24',    ids:{aid:"2334343",
            tid:"5345435"
        }},
            {groupId:'aad23',    ids:{aid:"2334343",
            tid:"5345435"
        }},
            {groupId:'aad22',    ids:{aid:"2334343",
            tid:"5345435"
        }}],
                ...
                if (response.status === 200) {
                    ...
                    response.json().then((respData) => {
                        respData = {
                            ...
                            "data": [{
                                'subscriptionId': '0idLmsMk8e0idLmsMk8e0idLmsMk8e0idLmsMk8e',
                                'serviceUri':'',
                                'adminToken':'',
                                'clientId':'',
                                'clientSd':''
                        ...
                        if (respData.errorStatus.status == 'ok') {
                            ...
                            if (subscriptions === null) {
                                ...
                                subscriptions = ['0idLmsMk8e', '5bNpSD7I4M', '9AEFGx1Ues'];
                                agentForm.subscriptionId.value = subscriptions[0];
    ...
    changeFormAutofill(selectedSubscriptionId) {
        ...
        if (selectedSubscriptionId != '') {
            ...
            selectedSubscription=[{'subscriptionId': '0idLmsMk8e',
            'serviceUri':'',
            'adminToken':'',
            'clientId':'',
            'clientSd':'',
            'uaaUrl':'https://762d7f9b-2140-4e61-b92d-ab8017dd2a46.predix-uaa.run.aws-usw02-dev.ice.predix.io'
        }];
    ...
    handleGatewayFormValidation() {
        ...
        if (gatewayPortValue.trim() === '') {
            ...
            formIsValid = false;
            console.log("Gateway"+formIsValid)
        }
            ...
            formIsValid = false;
            console.log("Gateway Port"+formIsValid)
        }
        ...
        if (zoneValue.trim() === '') {
            ...
            formIsValid = false;
            console.log("Zone must have 36 character"+formIsValid)
        }
        ...
        if (serviceUrlValue.trim() === '') {
            ...
            formIsValid = false;
            console.log("Service Url"+formIsValid)
        }
            ...
            formIsValid = false;
            console.log("Valid Url"+formIsValid)
        }
        ...
        if (hostValue.trim() === '') {
            ...
            formIsValid = false;
            console.log("Host starts with wss:// or ws://ost"+formIsValid)
        }
            ...
            formIsValid = false;
            console.log("Host ends with /agent"+formIsValid)
        }
    ...
    handleServerFormValidation() {
        ...
        if (agentIdValue.trim() === '') {
            ...
            formIsValid = false;
            console.log("Agent Id"+formIsValid)
        }
            ...
            formIsValid = false;
           console.log("6 chr Agent Id"+formIsValid )
        }
        ...
        if (clientIdValue.trim() === '') {
            ...
            formIsValid = false;
                errors.clientId = 'Please enter Client Id';
            console.log("Client"+formIsValid )
        }
        ...
        if (clientSecretValue === '') {
            ...
            formIsValid = false;
            console.log("Client Secret"+formIsValid )
        }
        ...
        if (durationValue === '') {
            ...
            formIsValid = false;
            console.log("Duration"+formIsValid )
        }
            ...
            formIsValid = false;
            console.log("least 1200"+formIsValid )
        }
        ...
        if (OAuth2Value.trim() === '') {
            ...
            formIsValid = false;
            console.log("OAuth2"+formIsValid )
        }
        ...
        if (hostValue.trim() === '') {
            ...
            formIsValid = false;
            console.log("Host starts with wss:// or ws://"+formIsValid )
        }
        else if (hostValue.substr(hostValue.length - 6, 6) != '/agent') {
            if (hostDirtyState) {
                errors.host = 'Host ends with /agent';
        ...
        if (zoneValue.trim() === '') {
            ...
            formIsValid = false;
            console.log("Please enter Zone"+formIsValid )
        ...
        if (serviceUrlValue.trim() === '') {
            ...
            formIsValid = false;
            console.log("Please enter Service Url"+formIsValid )
        }
        else if (!urlRegExp.test(serviceUrlValue)) {
            if (serviceUrlDirtyState) {
                errors.serviceUrl = 'Please enter valid URL';
            ...
            formIsValid = false;
            console.log("Please enter valid URL"+formIsValid )
        }
        ...
        if (remoteHostValue.trim() === '') {
            ...
            formIsValid = false;
            console.log("Please enter Remote Host"+formIsValid )
        }
        ...
        if (remotePortValue.trim() === '') {
            ...
            formIsValid = false;
            console.log("Please enter Remote Port in digit"+formIsValid )
        }
            ...
            formIsValid = false;
            console.log("Remote Port must have 4 digit"+formIsValid )
        }
        ...
        if (allowPlugInValue) {
            if (plugInValue.length === 0) {
                ...
                formIsValid = false;
                console.log("Please select Plug-In"+formIsValid )
            }
        }
        ...
        if (hcaValue.trim() === '') {
            ...
            formIsValid = false;
            console.log("Please enter Health Port in digit"+formIsValid )
        }
            ...
            formIsValid = false;
            console.log("Health Port must have 4 digit"+formIsValid )
        }
    ...
    handleClientFormValidation() {
        ...
        if (agentIdValue.trim() === '') {
            ...
            console.log("Please enter Agent Id"+formIsValid )
            formIsValid = false;
            ...
            console.log("Agent Id must have 6 character"+formIsValid )
            formIsValid = false;
        }
        ...
        if (groupValue.trim() === '') {
            ...
            console.log("Please enter Group"+formIsValid )
            formIsValid = false;
        }
        ...
        if (clientIdValue.trim() === '') {
            ...
            console.log("Please enter Client Id"+formIsValid )
            formIsValid = false;
        }

        if (clientSecretValue.trim()  === '' || clientSecretValue === '')  {
            if (clientSecretDirtyState) {
                errors.clientSecret = 'Please enter Client Secret';
            }
            console.log("Please enter Client Secret"+formIsValid )
            formIsValid = false;
        }
        ...
        if (durationValue === '') {
            ...
            console.log("Please enter Duration in digit"+formIsValid )
            formIsValid = false;
        }
        else if (durationValue < 1200) {
            if (durationDirtyState) {
            ...
            console.log("Duration at least 1200"+formIsValid )
            formIsValid = false;
        }
        ...
        if (OAuth2Value.trim() === '') {
            ...
            console.log("Please enter OAuth2"+formIsValid )
            formIsValid = false;
        }
        else if (!urlRegExp.test(OAuth2Value)) {
            if (OAuth2DirtyState) {
            ...
            console.log("Please enter URL"+formIsValid )
            formIsValid = false;
        }
        ...
        if (hostValue.trim() === '') {
            ...
            console.log("Please enter Host"+formIsValid )
            formIsValid = false;
        }
        else if (hostValue.substr(0, 6) != 'wss://' && hostValue.substr(0, 5) != 'ws://') {
            if (hostDirtyState) {
        ...
        if (localPortValue.trim() === '') {
            ...
            console.log("Please enter Local Port in digit"+formIsValid )
            formIsValid = false;
        }
            ...
            console.log("Local Port must have 4 digit"+formIsValid )
            formIsValid = false;
        }
        ...
        if (targetIdValue.trim() === '') {
            ...
            console.log("Please enter Target Id"+formIsValid )
            formIsValid = false;
        }
            ...
            console.log("Target Id must have 6 character"+formIsValid )
            formIsValid = false;
        }
