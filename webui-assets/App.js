		...
		></Header>
                    ...
                    <div className="modal fade notificationModal" id="notificationModal" role="dialog" data-backdrop="static" data-keyboard="false">
                      <div className="modal-dialog modal-md">
                        <div className={this.state.isCommandPrompt ? "modal-content rounded-0 command-prompt" : "modal-content rounded-0" }>
                          <div className="modal-header rounded-0">
                            <h6 className="modal-title text-middle">{this.state.notificationModal.headerText}</h6>
                          </div>
                          <div className="modal-body">
                            {this.state.isCommandPrompt ?<div>
                                    <pre>
                                        <code>
                                        {this.state.notificationModal.commands.map(
                                            (cmd, indx) => {
                                            return (
                                                <p key={indx + "cmd"} className="text-left">
                                                {cmd}
                                                </p>
                                            );
                                            }
                                    ...
                                    <button type="button" className="copy-icon" onClick={this.actionPerform.bind(this,"copyToClipboard")}>
                                        <svg
                                ...
                                </div> : <p> {this.state.notificationModal.bodyText} </p>
                            }
                          </div>
                          <div className="modal-footer">
