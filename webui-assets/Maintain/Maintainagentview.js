...
export default class Maintainagentview extends React.Component {
  ...
  componentDidMount() {
    ...
    fetch("https://reqres.in/api/users/2", {
      //this.props.baseUrl+'/listGateways?user_id='+this.props.userId, { // Get gateways
      method: "GET",
      headers: {
      ...
      if (response.status === 200) {
        response.json().then((respData) => {
          let gateways = [
            {
              ...
              admToken:
                "YWRtaW46WUo1NVBpWUkwWXpZcmpFQjVsc0dNNGdOcVRTSDlwS1l5RFJXcldOTElwSjA0TlBJM1M=",
          ...
          fetch("https://reqres.in/api/users/2", {
            //this.props.baseUrl + '/listServers?user_id='+this.props.userId, { // Get servers
            method: "GET",
            headers: {
              Accept: "application/json",
              "Content-Type": "application/json",
            ...
            if (response.status === 200) {
              response.json().then((respData) => {
                ...
                fetch("https://reqres.in/api/users/2", {
                  //this.props.baseUrl + '/listClients?user_id='+this.props.userId, { // Get clients
                  method: "GET",
                  headers: {
                    Accept: "application/json",
                    "Content-Type": "application/json",
                  ...
                  if (response.status === 200) {
                    response.json().then((respData) => {
                      let clients = [
                        {
                          clientId:
                            "Client-1b95c319-aa6c-44ba-8c2f-2b1764efe697",
                          gatewayId:
                            "Gateway-16450058-e7e3-4ac2-9315-5fa93afaf709",
                          userId: "212712078",
                          hostUrl: "wss://gateway-url/agent",
                          agentId: "hdsvhe",
                          targetId: "dhvhye",
                        ...
                        {
                          clientId:
                            "Client-45a222d9-50fa-48c8-a7ec-ec700a1ce44f",
                          gatewayId:
                            "Gateway-16450058-e7e3-4ac2-9315-5fa93afaf709",
                          userId: "212712078",
                          hostUrl: "wss://gateway-url/agent",
  ...
  /* istanbul ignore next */
  filterData(e) {
    this.destroyDataTable("maintainagentviewTable");
          ...
          <div className="centered-div">
            <div id="maintainagentviewTableDiv">
              {this.state.showTableInit ? (
                <table id="maintainagentviewTable" className="table text-center">
                  <thead>
                    <tr>
                      <th>Subscription</th>
                      <th>Agent ID</th>
