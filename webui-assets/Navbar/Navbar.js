            ...
            <nav className="navbar navbar-expand-md navbar-light">
                ...
                <div className="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul className="navbar-nav lower-navbar">
                        ...
                        <li className={this.props.currentView === 'Monitor' ? 'nav-item dropdown active' : 'nav-item dropdown'}>
                            <a className="nav-link" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
                            ...
                            <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li>
                                    <a className="dropdown-item" onClick={this.props.clickEve.bind(this, 'Monitor')} href="#">
                                        Notifications
                                    </a>
                                </li>
                                <li>
                        ...
                        <li className={this.props.currentView === 'Settings' ? 'nav-item dropdown active' : 'nav-item dropdown'}>
                            <a className="nav-link" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
                            ...
                            <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li>
                                    <a className="dropdown-item" onClick={this.props.clickEve.bind(this, 'Settings')} href="#">
                                        User Management
                                    </a>
                                </li>
                            </ul>
